...
function closeOrder() {
  ...
  if (window.innerWidth <= 700) {
    ...
    // Приховуємо все, крім цифри
    cartBox.querySelector("ul").style.display = "none";
    cartBox.querySelector("p").style.display = "none";
    cartBox.querySelector(".buttons").style.display = "none";
  }
}
